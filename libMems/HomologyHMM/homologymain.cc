...
void run(std::string& sequence, std::string& prediction,  double goHomologous, double goUnrelated, std::vector<double>* emitHomologous, std::vector<double>* emitUnrelated) 
{
