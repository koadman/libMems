...
void run(std::string& sequence, std::string& prediction, const vector<double>& emitHomologous, const vector<double>& emitUnrelated,double goHomologous = 0.004, double goUnrelated = 0.004);
