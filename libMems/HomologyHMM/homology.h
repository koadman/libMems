...
/* Generated from file homology.xml (author: Aaron Darling) on Tue Jun 19 11:11:57 EST 2007 */
...
class HomologyBaumWelch {
    ...
    bfloat transitionBaumWelchCount0[6];
    static int transitionIdentifier0[6];   
    static const int transitionDimension0 = 6;
