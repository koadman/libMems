...
void run(std::string& sequence, std::string& prediction, vector<double>* emitHomologous, vector<double>* emitUnrelated,double goHomologous = 0.004, double goUnrelated = 0.004);
