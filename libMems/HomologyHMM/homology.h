...
void run(std::string& sequence, std::string& prediction, std::vector<double>* emitHomologous, std::vector<double>* emitUnrelated,double goHomologous = 0.004, double goUnrelated = 0.004);
