...
void MemorySML::Create(const gnSequence& seq, const uint32 mersize ){
...
//	FillSML(sar_len, positions);
//	RadixSort(s_array);
//	MerCompare mycomp( this );
//	sort(positions.begin(), positions.end(), mycomp);
